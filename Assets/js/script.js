...
const intFromTime = 9;
const intToTime = 5;
const strDisplayedCurrDate = today.format('dddd MMMM, D');
divDisplayCurrentDay.textContent = strDisplayedCurrDate;
...
$(function () {
  ...
  for (var i = 0; i < objTimeObject.HourstoDisplay.length; i++) {
    ...
    } else strTxtAreaId = strTxtAreaId + objTimeObject.HourstoDisplay[i];
    ...
    var elm = '<div ' +
      ...
      '<textarea class="col-8 col-md-10 description" rows="3" id="' + strTxtAreaId + '">' + strTxtAreaContent + ' </textarea> ' +
  ...
  $('#container').on('click', ':button', function (event) {
    ...
    localStorage.setItem('calDayEvents', JSON.stringify(tempArr)) //convert array of objects to json and store it
